...
<head>
    ...
    <link rel='icon' href="/TwitteClone/iews/img/logo-twitterblue.svg">
    <!-- Bootstrap css-->
    ...
    <meta name='discription' contents='会員登録画面です'>
</head>
...
<body class="signup text-center">
   <main class = "form-signup">
     <form action = "sign-up.php" method = "post">
        ...
        <input type = "password" class = "form-control" name = "passwaord" placeholder = "パスワード" minlength = "4" maxlength = "128" require>
